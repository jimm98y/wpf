...
namespace System.Windows.Documents
{
    internal partial class ImmComposition
    {
        ...
        /// <summary>
        /// Removes text around the caret at the input method's request. AppKit counts in UTF-16
        /// units -- the same unit the document uses -- so unlike the Wayland path there is no byte
