...
namespace Microsoft.Wpf.Interop.WebGpu.Composition.Text
{
    internal sealed partial class TrueTypeInterpreter
    {
        ...
        private static string OpName(byte op) => op switch
        {
            ...
            0x40 or 0x41 => "NPUSH",
            >= 0xB0 and <= 0xBF => "PUSH",
            // THE REST OF THE INSTRUCTION SET, because "op (0x48)" is unreadable in a trace and
            // reading a trace is how the glyph programs get understood. The block that shapes
            // Times' bowls is twenty instructions of stack arithmetic feeding two SCFSes, and
            // every one of them printed as `op` until now.
            0x02 or 0x03 => "SPVTCA", 0x04 or 0x05 => "SFVTCA",
            0x06 or 0x07 => "SPVTL", 0x08 or 0x09 => "SFVTL",
            0x0A => "SPVFS", 0x0B => "SFVFS", 0x0C => "GPV", 0x0D => "GFV",
            0x0E => "SFVTPV", 0x0F => "ISECT",
            0x10 => "SRP0", 0x11 => "SRP1", 0x12 => "SRP2", 0x13 => "SZP0",
            0x14 => "SZP1", 0x15 => "SZP2", 0x16 => "SZPS", 0x17 => "SLOOP",
            0x18 => "RTG", 0x19 => "RTHG", 0x1A => "SMD", 0x1B => "ELSE",
            0x1C => "JMPR", 0x1D => "SCVTCI", 0x1E => "SSWCI", 0x1F => "SSW",
            0x20 => "DUP", 0x21 => "POP", 0x22 => "CLEAR", 0x23 => "SWAP",
            0x24 => "DEPTH", 0x25 => "CINDEX", 0x26 => "MINDEX", 0x27 => "ALIGNPTS",
            0x29 => "UTP", 0x2C => "FDEF", 0x2D => "ENDF",
            0x38 => "SHPIX", 0x3C => "ALIGNRP", 0x3D => "RTDG",
            0x42 => "WS", 0x43 => "RS", 0x44 => "WCVTP", 0x45 => "RCVT",
            0x46 or 0x47 => "GC", 0x48 => "SCFS", 0x49 or 0x4A => "MD",
            0x4B => "MPPEM", 0x4C => "MPS", 0x4D => "FLIPON", 0x4E => "FLIPOFF",
            0x4F => "DEBUG", 0x50 => "LT", 0x51 => "LTEQ", 0x52 => "GT",
            0x53 => "GTEQ", 0x54 => "EQ", 0x55 => "NEQ", 0x56 => "ODD",
            0x57 => "EVEN", 0x58 => "IF", 0x59 => "EIF", 0x5A => "AND",
            0x5B => "OR", 0x5C => "NOT", 0x5E => "SDB", 0x5F => "SDS",
            0x60 => "ADD", 0x61 => "SUB", 0x62 => "DIV", 0x63 => "MUL",
            0x64 => "ABS", 0x65 => "NEG", 0x66 => "FLOOR", 0x67 => "CEILING",
            0x68 or 0x69 or 0x6A or 0x6B => "ROUND", 0x6C or 0x6D or 0x6E or 0x6F => "NROUND",
            0x70 => "WCVTF", 0x73 => "DELTAC1", 0x74 => "DELTAC2", 0x75 => "DELTAC3",
            0x76 => "SROUND", 0x77 => "S45ROUND", 0x78 => "JROT", 0x79 => "JROF",
            0x7A => "ROFF", 0x7C => "RUTG", 0x7D => "RDTG", 0x7E => "SANGW",
            0x7F => "AA", 0x80 => "FLIPPT", 0x81 => "FLIPRGON", 0x82 => "FLIPRGOFF",
            0x85 => "SCANCTRL", 0x86 or 0x87 => "SDPVTL", 0x88 => "GETINFO",
            0x89 => "IDEF", 0x8A => "ROLL", 0x8B => "MAX", 0x8C => "MIN",
