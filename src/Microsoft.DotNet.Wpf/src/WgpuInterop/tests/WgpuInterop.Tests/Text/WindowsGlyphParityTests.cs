...
namespace WgpuInterop.Tests.Text
{
    public sealed class WindowsGlyphParityTests : RendererTestBase
    {
        ...
        private static readonly Dictionary<string, int> Allowed = new()
        {
            ...
            ["@"] = 54,
            ["A"] = 33,
            ["ABCDEFGHIJKLM@11"] = 295,
            ["ABCDEFGHIJKLM@12"] = 381,
            ["ABCDEFGHIJKLM@13"] = 373,
            ["ABCDEFGHIJKLM@16"] = 441,
            ["ABCDEFGHIJKLM@19"] = 524,
            ["B"] = 30,
            ["C"] = 26,
            ["Cancel Apply@12b"] = 246,
            ["Cancel Apply@12bi"] = 206,
            ["Cancel Apply@12i"] = 199,
            ["Cancel Apply@16b"] = 283,
            ["Cancel Apply@16bi"] = 251,
            ["Cancel Apply@16i"] = 279,
            ["D"] = 34,
            ["E"] = 18,
            ["F"] = 18,
            ["G"] = 29,
            ...
            ["Handgloves@16i"] = 262,
            ["I"] = 18,
            ["Illinois still@11"] = 255,
            ["Illinois still@12"] = 155,
            ["Illinois still@13"] = 177,
            ["Illinois still@16"] = 290,
            ["Illinois still@19"] = 348,
            ["J"] = 18,
            ["K"] = 32,
            ["L"] = 18,
            ["M"] = 64,
            ["N"] = 54,
            ["NOPQRSTUVWXYZ@11"] = 380,
            ["NOPQRSTUVWXYZ@12"] = 421,
            ["NOPQRSTUVWXYZ@13"] = 422,
            ["NOPQRSTUVWXYZ@16"] = 474,
            ["NOPQRSTUVWXYZ@19"] = 588,
            ["O"] = 34,
            ["P"] = 25,
            ["Příliš@12b"] = 113,
            ["Příliš@12bi"] = 100,
            ...
            ["`"] = 4,
            ["a"] = 18,
            ["abcdefghijklm@11"] = 358,
            ["abcdefghijklm@12"] = 245,
            ["abcdefghijklm@13"] = 304,
            ["abcdefghijklm@16"] = 412,
            ["abcdefghijklm@19"] = 446,
            ["b"] = 19,
            ["c"] = 14,
            ["d"] = 30,
            ["e"] = 15,
            ...
            ["m"] = 38,
            ["n"] = 13,
            ["nopqrstuvwxyz@11"] = 320,
            ["nopqrstuvwxyz@12"] = 266,
            ["nopqrstuvwxyz@13"] = 310,
            ["nopqrstuvwxyz@16"] = 397,
            ["nopqrstuvwxyz@19"] = 461,
            ["o"] = 20,
            ["p"] = 19,
            ["q"] = 30,
            ["r"] = 7,
            ["repertoire@10"] = 2320,
            ["repertoire@10b"] = 2398,
            ["repertoire@10bi"] = 2205,
            ["repertoire@10i"] = 2217,
            ["repertoire@11"] = 3205,
            ["repertoire@11b"] = 2938,
            ["repertoire@11bi"] = 2546,
            ["repertoire@11i"] = 2576,
            ["repertoire@12"] = 3212,
            ["repertoire@12b"] = 3120,
            ["repertoire@12bi"] = 2773,
            ["repertoire@12i"] = 2809,
            ["repertoire@13"] = 3360,
            ["repertoire@13b"] = 3182,
            ["repertoire@13bi"] = 2974,
            ["repertoire@13i"] = 3008,
            ["repertoire@14"] = 3575,
            ["repertoire@14b"] = 3404,
            ["repertoire@14bi"] = 3081,
            ["repertoire@14i"] = 3172,
            ["repertoire@15"] = 3874,
            ["repertoire@15b"] = 3717,
            ["repertoire@15bi"] = 3391,
            ["repertoire@15i"] = 3586,
            ["repertoire@16"] = 4113,
            ["repertoire@16b"] = 3920,
            ["repertoire@16bi"] = 3468,
            ["repertoire@16i"] = 3760,
            ["repertoire@17"] = 4423,
            ["repertoire@17b"] = 4234,
            ["repertoire@17bi"] = 3937,
            ["repertoire@17i"] = 4044,
            ["repertoire@18"] = 4814,
            ["repertoire@18b"] = 4393,
            ["repertoire@18bi"] = 4028,
            ["repertoire@18i"] = 4245,
            ["repertoire@19"] = 4872,
            ["repertoire@19b"] = 4718,
            ["repertoire@19bi"] = 4277,
            ["repertoire@19i"] = 4498,
            ["repertoire@20"] = 6318,
            ["repertoire@20b"] = 5576,
            ["repertoire@20bi"] = 5242,
            ["repertoire@20i"] = 5338,
            ["s"] = 14,
            ["t"] = 16,
            ["u"] = 33,
