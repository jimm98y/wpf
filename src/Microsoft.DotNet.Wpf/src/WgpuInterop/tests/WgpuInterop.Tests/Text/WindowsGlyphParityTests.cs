...
namespace WgpuInterop.Tests.Text
{
    public sealed class WindowsGlyphParityTests : RendererTestBase
    {
        ...
        private static readonly Dictionary<string, int> Allowed = new()
        {
            ...
            ["@"] = 39,
            ["A"] = 11,
            ["ABCDEFGHIJKLM@11"] = 243,
            ["ABCDEFGHIJKLM@12"] = 106,
            ["ABCDEFGHIJKLM@13"] = 324,
            ["ABCDEFGHIJKLM@16"] = 259,
            ["ABCDEFGHIJKLM@19"] = 195,
            ["B"] = 8,
            ["C"] = 13,
            ["Cancel Apply@12b"] = 99,
            ["Cancel Apply@12bi"] = 9,
            ["Cancel Apply@12i"] = 8,
            ["Cancel Apply@16b"] = 176,
            ["Cancel Apply@16bi"] = 10,
            ["Cancel Apply@16i"] = 13,
            ["D"] = 7,
            ["E"] = 2,
            ["F"] = 2,
            ...
            ["Handgloves@16i"] = 11,
            ["I"] = 9,
            ["Illinois still@11"] = 182,
            ["Illinois still@12"] = 54,
            ["Illinois still@13"] = 81,
            ["Illinois still@16"] = 70,
            ["Illinois still@19"] = 98,
            ["J"] = 1,
            ["K"] = 5,
            ["L"] = 1,
            ["M"] = 2,
            ["N"] = 0,
            ["NOPQRSTUVWXYZ@11"] = 264,
            ["NOPQRSTUVWXYZ@12"] = 204,
            ["NOPQRSTUVWXYZ@13"] = 283,
            ["NOPQRSTUVWXYZ@16"] = 224,
            ["NOPQRSTUVWXYZ@19"] = 336,
            ["O"] = 21,
            ["P"] = 11,
            ["Příliš@12b"] = 74,
            ["Příliš@12bi"] = 13,
            ...
            ["`"] = 3,
            ["a"] = 10,
            ["abcdefghijklm@11"] = 217,
            ["abcdefghijklm@12"] = 115,
            ["abcdefghijklm@13"] = 178,
            ["abcdefghijklm@16"] = 181,
            ["abcdefghijklm@19"] = 319,
            ["b"] = 4,
            ["c"] = 13,
            ["d"] = 7,
            ["e"] = 9,
            ...
            ["m"] = 34,
            ["n"] = 2,
            ["nopqrstuvwxyz@11"] = 181,
            ["nopqrstuvwxyz@12"] = 86,
            ["nopqrstuvwxyz@13"] = 179,
            ["nopqrstuvwxyz@16"] = 192,
            ["nopqrstuvwxyz@19"] = 254,
            ["o"] = 5,
            ["p"] = 4,
            ["q"] = 7,
            ["r"] = 0,
