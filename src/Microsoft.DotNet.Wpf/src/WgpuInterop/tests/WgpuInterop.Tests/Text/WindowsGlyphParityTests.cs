...
namespace WgpuInterop.Tests.Text
{
    public sealed class WindowsGlyphParityTests : RendererTestBase
    {
        ...
        private static readonly Dictionary<string, int> Allowed = new()
        {
            ...
            ["@"] = 46,
            ["A"] = 3,
            ["ABCDEFGHIJKLM@11"] = 142,
            ["ABCDEFGHIJKLM@12"] = 220,
            ["ABCDEFGHIJKLM@13"] = 324,
            ["ABCDEFGHIJKLM@16"] = 84,
            ["ABCDEFGHIJKLM@19"] = 134,
            ["B"] = 20,
            ["C"] = 9,
            ["Cancel Apply@12b"] = 121,
            ["Cancel Apply@12bi"] = 9,
            ["Cancel Apply@12i"] = 8,
            ["Cancel Apply@16b"] = 78,
            ...
            ["M"] = 35,
            ["N"] = 22,
            ["NOPQRSTUVWXYZ@11"] = 137,
            ["NOPQRSTUVWXYZ@12"] = 161,
            ["NOPQRSTUVWXYZ@13"] = 211,
            ["NOPQRSTUVWXYZ@16"] = 59,
            ...
            ["`"] = 2,
            ["a"] = 11,
            ["abcdefghijklm@11"] = 196,
            ["abcdefghijklm@12"] = 155,
            ["abcdefghijklm@13"] = 214,
            ...
            ["m"] = 36,
            ["n"] = 8,
            ["nopqrstuvwxyz@11"] = 188,
            ["nopqrstuvwxyz@12"] = 106,
            ["nopqrstuvwxyz@13"] = 148,
