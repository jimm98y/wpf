...
/// <summary>
/// The UIKit half: make a window, hand its root UIView to the WPF fork, and start the media page.
/// Identical in shape to the gallery head's scene delegate; only the payload differs.
/// </summary>
